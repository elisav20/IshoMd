            ...
            <div class="col-md-9 single-main-left">
                <div class="sngl-top">
                    <div class="col-md-5 single-top-left">
                        ...
                        <?php } else { ?>
                        <div data-thumb="images/<?= $product['img']; ?>">
                            <div class="thumb-image">
                                <img src="images/<?= $product['img']; ?>" data-imagezoom="true" class="img-responsive"
                                    alt="">
                            </div>
                        </div>
                        <?php } ?>
                    ...
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <h5 class="item_price">
                                <?= $curr['symbol_left']; ?>
                                <span id="base-price"
                                    data-price="<?= round($product['price'] * $curr['value'], 2); ?>"><?= round($product['price'] * $curr['value'], 2); ?></span>
                                <?= $curr['symbol_right']; ?>
                                <?php if ($product['old_price']) { ?>
                                <small>
                                    <del>
                                        <?= $curr['symbol_left']; ?>
                                        <?= round($product['old_price'] * $curr['value'], 2); ?>
                                        <?= $curr['symbol_right']; ?>
                                    </del>
                                </small>
                                <?php } ?>
                            ...
                            <a id="productAdd" data-id="<?= $product['id']; ?>" href="cart/add?id=<?= $product['id'] ?>"
                                class="add-cart add-to-cart-link item_add">ADD
                                TO CART</a>
                        ...
                        <div class="col-md-4 product-left p-left">
                            <div class="product-main simpleCart_shelfItem">
                                <a href="product/<?= $item['alias']; ?>" class="mask"><img
                                        class="img-responsive zoom-img" src="images/<?= $item['img']; ?>" alt="" /></a>
                                <div class="product-bottom">
                                    <h3><a href="product/<?= $item['alias']; ?>"><?= $item['title']; ?></a></h3>
                                    <p><a href="product/<?= $item['alias']; ?>">Explore Now</a></p>
                                    <h4><a class="item_add add-to-cart-link" href="cart/add?=<?= $item['id']; ?>"
                                            data-id="<?= $item['id']; ?>">
                                        </a>
                                        <span class=" item_price">
                                            <?= $curr['symbol_left']; ?>
                                            <?= round($item['price'] * $curr['value'], 2); ?>
                                            <?= $curr['symbol_right']; ?>
                                            <?php if ($item['old_price']) { ?>
                                            <small>
                                                <del>
                                                    <?= $curr['symbol_left']; ?>
                                                    <?= round($item['old_price'] * $curr['value'], 2); ?>
                                                    <?= $curr['symbol_right']; ?>
                                                </del>
                                            </small>
                                            <?php } ?>
                                ...
                                <?php if ($item['old_price']) { ?>
                                <div class="srch">
                                    <span><?= floor(100 - $item['price'] / $item['old_price'] * 100); ?>%</span>
                                </div>
                                <?php } ?>
                            </div>
                        </div>
